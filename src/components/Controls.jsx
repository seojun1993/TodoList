...
const Controls = () => {
  const { state, dispatch } = useContext(TodoContext);
    ...
    const handleChangeFilterType = (e) => { dispatch({ type: SET_FILTER, payload : e.target.value }) };
  ...
  return (
    <div className={styles.controls}>
      ...
      <select className={styles.select} value={state.filterType} onChange={handleChangeFilterType}>
